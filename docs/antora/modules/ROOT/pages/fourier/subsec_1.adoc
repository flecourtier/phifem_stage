...
*  stem:[\mathcal{B}_\theta^l] is the "bias-layer". For more details, see <<_bias_sub-layer>>.
...
For more details about the Convolution sub-layer, see xref:fourier/subsec_2.adoc[Section "Some details on the convolution sub-layer"].

...
In xref:corr/subsec_2_subsubsec_2.adoc[Section "Error estimation of the correction on the elevated problem"], we will prove the following inequality in the context of this problem

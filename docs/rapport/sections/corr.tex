...
\paragraph{Second problem} \label{Corr.pb.circle.2}
...
In the non-homogeneous case, it is important to impose the boundary conditions either by the direct method in Section \ref{FEMs.PhiFEM.direct_method} or by the dual method presented in Section \ref{FEMs.PhiFEM.dual_method}.
...
In Section \ref{Corr.theo_results.error_reh}, we have prove the following inequality in the context of this problem
...
In this section, we will define the relative error and the absolute error between the exact solution $u_{ex}$ and $u_{method}$ by :
\begin{equation*}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.55\linewidth]{"corr_phifem/phifem_solution.png"}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\linewidth]{corr_FNO/misfits_f_gaussienne.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.85\linewidth]{corr_FNO/erreur_val_f_gaussienne.png}
...
\begin{minipage}{0.48\linewidth}
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.8\linewidth]{corr_FNO/boxplot_val_f_gaussienne.png}
...
\begin{minipage}{0.58\linewidth}
	\begin{figure}[H]
		\centering
		\includegraphics[width=\linewidth]{corr_FNO/corr_boxplot.png}
		\caption{Errors obtained with the FNO and with different correction methods according to checkpoints.}
		\label{corr_boxplot}
	\end{figure}
\end{minipage} $\quad$
\begin{minipage}{0.38\linewidth}
	\begin{figure}[H]
		\centering
		\includegraphics[width=\linewidth]{corr_FNO/corr_boxplot_errors.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.4\linewidth]{corr_networks/MLP_loss.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.65\linewidth]{corr_networks/MLP_solution.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.4\linewidth]{corr_networks/MLP_corr_add_FEM.png}
...
\begin{minipage}{0.48\linewidth}
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.6\linewidth]{corr_networks/MLP_derivees_premieres.png}
...
\begin{minipage}{0.48\linewidth}
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.6\linewidth]{corr_networks/MLP_derivees_secondes.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\linewidth]{corr_networks/PINNs_loss.png}
...
\begin{minipage}{0.48\linewidth}
	\begin{figure}[H]
		\centering
		\includegraphics[width=\linewidth]{corr_networks/PINNs_derivees_premieres.png}
...
\begin{minipage}{0.48\linewidth}
	\begin{figure}[H]
		\centering
		\includegraphics[width=\linewidth]{corr_networks/PINNs_derivees_secondes.png}

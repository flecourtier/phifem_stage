...
\modif{A rajouter : - implémentation effectuée/fournie par Vincent Vigon

- on ne trouvera pas ici de test de variation des paramètres (modes, width...)}
...
\subsection{General structure of the FNO} \label{FNO.general}
